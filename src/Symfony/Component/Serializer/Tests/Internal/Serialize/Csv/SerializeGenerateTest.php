...
namespace Symfony\Component\Serializer\Tests\Internal\Serialize\Csv;
...
class SerializeGenerateTest extends TestCase
{
    ...
    public static function serializeGenerateDataProvider(): iterable
    {
        ...
        yield [
            ...
            return static function (mixed \$data, mixed \$resource, array \$context): void {
                if (!\\is_iterable(\$data)) {
                    throw new \\Symfony\\Component\\Serializer\\Exception\\UnexpectedValueException(\\sprintf("Expecting first level data type to be a list, but got \\"%s\\".", \\get_debug_type(\$data)));
                }
        ...
        yield [
            ...
            /**
             * @param array<int, Symfony\\Component\\Serializer\\Tests\\Fixtures\\Enum\\DummyBackedEnum> \$data
             * @param resource \$resource
             */
            return static function (mixed \$data, mixed \$resource, array \$context): void {
                \\fputcsv(\$resource, [0], \$context["csv_separator"] ?? ",", \$context["csv_enclosure"] ?? "\\"", \$context["csv_escape_char"] ?? "\\\\", "");
        ...
        yield [
            ...
            /**
             * @param array<int, Symfony\Component\Serializer\Tests\Fixtures\Dto\ClassicDummy> \$data
             * @param resource \$resource
             */
            return static function (mixed \$data, mixed \$resource, array \$context): void {
                \$headers_0 = ["id", "name"];
