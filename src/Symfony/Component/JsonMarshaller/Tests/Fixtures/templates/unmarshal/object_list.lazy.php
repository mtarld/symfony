...
return static function (mixed $resource, array $config, \Symfony\Component\JsonMarshaller\Unmarshal\Instantiator\InstantiatorInterface $instantiator, ?\Psr\Container\ContainerInterface $services): mixed {
    ...
    $providers["array<int, Symfony\\Component\\JsonMarshaller\\Tests\\Fixtures\\Dto\\ClassicDummy>"] = static function (mixed $resource, int $offset, int $length) use ($config, $instantiator, &$providers, $jsonDecodeFlags): array {
    ...
    return ($providers["array<int, Symfony\\Component\\JsonMarshaller\\Tests\\Fixtures\\Dto\\ClassicDummy>"])($resource, 0, -1);
};
