...
final class TemplateGenerator
{
    ...
    private function objectNodes(Type $type, NodeInterface $accessor, array $context): array
    {
        ...
        if (isset($context['hooks']['serialize'][$className = $type->className()])) {
            $hook = $context['hooks']['serialize'][$className];
        } elseif (isset($context['hooks']['serialize']['object'])) {
            $hook = $context['hooks']['serialize']['object'];
        }
        ...
        foreach ($class->getProperties() as $property) {
            ...
            if (isset($context['hooks']['serialize'][$className.'::$'.$propertyName])) {
                $hook = $context['hooks']['serialize'][$className.'::$'.$propertyName];
            } elseif (isset($context['hooks']['serialize']['property'])) {
                $hook = $context['hooks']['serialize']['property'];
            }
