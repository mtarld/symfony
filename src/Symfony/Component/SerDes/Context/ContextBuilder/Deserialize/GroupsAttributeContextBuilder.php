 ...
 * @experimental in 7.0
 */
final class GroupsAttributeContextBuilder implements DeserializeContextBuilderInterface
{
    /**
     * @var array<class-string, array<string, list<string>>>|null
     */
    ...
    public function build(array $context): array
    {
        ...
        $context['_symfony']['deserialize']['property_groups'] = self::$cache;
