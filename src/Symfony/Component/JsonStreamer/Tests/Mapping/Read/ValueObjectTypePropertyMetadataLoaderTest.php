...
class ValueObjectTypePropertyMetadataLoaderTest extends TestCase
{
    public function testAddDateTimeValueTransformer()
    {
        ...
        $this->assertEquals([
            'dateTime' => new PropertyMetadata('dateTime', Type::string(), [], ['json_streamer.value_transformer.scalar_to_date_time']),
            'other' => new PropertyMetadata('other', Type::object(self::class)),
    ...
    public function testAddBcMathNumberValueTransformer()
    {
        ...
        $this->assertEquals([
            'number' => new PropertyMetadata('number', Type::union(Type::int(), Type::string()), [], ['json_streamer.value_transformer.scalar_to_bc_math_number']),
            'other' => new PropertyMetadata('other', Type::object(self::class)),
        ], $loader->load(self::class));
    }
    ...
    public function testAddGmpNumberValueTransformer()
    {
        ...
        $this->assertEquals([
            'number' => new PropertyMetadata('number', Type::union(Type::int(), Type::string()), [], ['json_streamer.value_transformer.scalar_to_gmp_number']),
            'other' => new PropertyMetadata('other', Type::object(self::class)),
        ], $loader->load(self::class));
    }
