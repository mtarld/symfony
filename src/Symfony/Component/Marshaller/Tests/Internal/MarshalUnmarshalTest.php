...
class MarshalUnmarshalTest extends TestCase
{
     ...
     */
    public function testMarshalUnmarshal(mixed $data, string $type, array $context = [])
    {
     ...
     * @param array<string, mixed> $context
     */
    public function testUnmarshalMarshal(string $content, string $type, array $context = [])
    {
        /** @var resource $resource */
        $resource = fopen('php://memory', 'w+');
