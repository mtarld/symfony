...
return static function (mixed $resource, array $config, \Symfony\Component\Encoder\Instantiator\InstantiatorInterface $instantiator, ?\Psr\Container\ContainerInterface $services): mixed {
    ...
    $providers["array<int,Symfony\\Component\\Json\\Tests\\Fixtures\\Model\\ClassicDummy>"] = static function (mixed $resource, int $offset, int $length) use ($config, $instantiator, $services, &$providers, $jsonDecodeFlags): array {
    ...
    return ($providers["array<int,Symfony\\Component\\Json\\Tests\\Fixtures\\Model\\ClassicDummy>"])($resource, 0, -1);
};
