...
final class CachedFormatterAttributeContextBuilderTest extends TestCase
{
    public function testCacheMarshalPropertyFormatters(): void
    {
        ...
        $contextBuilder
            ...
            ->willReturn(['_symfony' => ['property_formatter' => 'marshal_property_formatter']]);
        ...
        $this->assertSame(['not_cached' => 1, '_symfony' => ['property_formatter' => 'marshal_property_formatter']], $contextBuilder->buildMarshalContext(['not_cached' => 1], true));
        $this->assertSame(['not_cached' => 2, '_symfony' => ['property_formatter' => 'marshal_property_formatter']], $contextBuilder->buildMarshalContext(['not_cached' => 2], true));
    ...
    public function testCacheUnmarshalPropertyFormatters(): void
    {
        ...
        $contextBuilder
            ...
            ->willReturn(['_symfony' => ['property_formatter' => 'unmarshal_property_formatter']]);
        ...
        $this->assertSame(['not_cached' => 1, '_symfony' => ['property_formatter' => 'unmarshal_property_formatter']], $contextBuilder->buildUnmarshalContext(['not_cached' => 1]));
        $this->assertSame(['not_cached' => 2, '_symfony' => ['property_formatter' => 'unmarshal_property_formatter']], $contextBuilder->buildUnmarshalContext(['not_cached' => 2]));
    }
}
